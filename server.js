...
**  ${prefix}ibot • get any bot by @ him**
...
**  ${prefix}mc • mute chat**
**  ${prefix}uc • unmute chat**
**  ${prefix}say • say anything**
`);
  }
});
...
client.on('message', wolf => {   if (wolf.content === 'hi') {     wolf.reply('hello');   } });
...
client.on("guildMemberAdd", member => {
if(member.guild.id === "763406218580328509") {
member.addRole("766175173522358272")
}
})
...
client.on('message' , roodx=>
{
    ...
    if(roodx.content.includes('https://') || roodx.content.includes('youtuop.com') || roodx.content.includes('discord.gg')|| roodx.content.includes('.net')|| roodx.content.includes('.com'))
    {
        roodx.delete();

        roodx.reply('تم معاقبتك ب ميوت  شاتي ل سبب النشر:anger: ')
        roodx.member.addRole(roodx.guild.roles.find('name' , 'mute'))
    }
})
